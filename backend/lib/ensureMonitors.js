/**
 * Phase 3 — monitors / checks / observations / alerts / incidents.
 * Idempotent boot ensure (aligned with migrations/003 + schema.sql).
 */
const DDL = [
...
async function ensureMonitorsTables(pool) {
