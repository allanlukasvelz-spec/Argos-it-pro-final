...
PHASE_6 = COMPLETE (runbooks + typed remediation; simulator L2; no customer infra mutation)
STASH = do not apply
```
...
| 6 | Runbooks + remediation | DONE (engine + simulator) | A/B/C needs a case |
| 7 | Agents | NEXT | extra observation source |
...
1. Phase 7 — Agents (solo con autorización humana)
2. Never `git stash pop`
3. No push/PR/deploy sin autorización humana explícita
4. Status: `docs/architecture/ARGOS_PHASE_6_STATUS.md` · Runbook: `docs/runbooks/ARGOS_PHASE_6_RUNBOOK_ENGINE.md`
